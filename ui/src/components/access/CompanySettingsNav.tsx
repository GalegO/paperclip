...
const items = [
  ...
  { value: "instance-memories", label: "Instance memories", href: `${INSTANCE_SETTINGS_PATH_PREFIX}/memories` },
...
export function getCompanySettingsTab(pathname: string): CompanySettingsTab {
  ...
  if (pathname.includes(`${INSTANCE_SETTINGS_PATH_PREFIX}/memories`)) {
